...
class MY_Model extends CI_Model {
     ...
     */
    function findWhereIn( $table, $field, $where_in_array )
    {
    ...
    */
    ...
    function select_data( $table, $where = array())
    { 
      if( empty( $table ) )       
        {       
            return false;
    ...
    public function custom_query($query,$count=false,$format = 'object'){
    ...
    function select_where( $select, $table, $where = array() )
    {
        $this->db->select( $select );
        $this->db->from( $table );
        $this->db->where( $where );
